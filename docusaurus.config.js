...
const config = {
  ...
  organizationName: "alonsoCan01", // Usually your GitHub org/user name.
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: "https://github.com/alonsoCan01/sample-docs",
            label: "GitHub",
            position: "right",
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Sample Docs,  Built with Docusaurus.`,
      },
      prism: {
